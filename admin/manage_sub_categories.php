...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong>Sous Catégories</strong><small> Form</small></div>
                        <form method="post">
							<div class="card-body card-block">
							   <div class="form-group">
								...
								<div class="form-group">
									<label for="categories" class=" form-control-label">Sous Catégories</label>
									<input type="text" name="sub_categories" placeholder="sous catégorie" class="form-control" required value="<?php echo $sub_categories?>">
								</div>
